...
function About() {
    return (
      <div className="about">
        ...
        <p>I have completed a 2-term internship at <span><a href="https://nrc.canada.ca/en/research-development/research-collaboration/research-centres/automotive-surface-transportation-research-centre" className="orange-link" target="_blank" rel="noreferrer">National Research Council Canada</a></span> and I am very familiar 
